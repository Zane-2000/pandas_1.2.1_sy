...
//-------761355061---添加事件5-----导出常量
export_constant(NPCF_SY_PET_MENU);		//pc_sy_pet_menu	//On_sy_petmenuFilter				//	当玩家点击宠物菜单时触发的实时事件
export_constant(NPCX_NATURAL_HEAL);		// sy_natural_heal	// OnPCNaturalHeal					// 当角色自动恢复时触发的事件
export_constant(NPCX_USE_CARD);		// sy_use_card	// OnPCUseCardFilter					// 当玩家使用卡片时触发的事件
export_constant(NPCX_LOOT_ITEMS);		// sy_moblootitems	// OnMOBlootitemsFilter					// 当魔物即将掠夺道具时触发的事件
export_constant(NPCX_TRADE_TRADEREQUEST);		// sy_trade_traderequest	// OnPCtraderequest					// 当玩家受到交易请求时触发的事件
export_constant(NPCX_TRADE_TRADEOK);			//sy_trade_tradeok					//	OnPCtradeok								// 当交易玩家点击确定时触发的事件
export_constant(NPCX_TRADE_TRADECOMMIT);			//sy_trade_tradecommit				//	OnPCtradercommit						// 当交易玩家点击交易时触发的事件
...
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	//-------------新增unit_mob控制常量-----------------------
	export_constant(UMOB_SY_ADDATTACKHARM);
	export_constant(UMOB_SY_ADDSKILLHARM);
	export_constant(UMOB_SY_SUBATTACKHARM);
	export_constant(UMOB_SY_SUBSKILLHARM);
	export_constant(UMOB_SY_HARM_ON);
	export_constant(UMOB_SY_HARM_1W_10);
	export_constant(UMOB_SY_HARM_10W_100);
	export_constant(UMOB_SY_HARM_100W_1K);
	export_constant(UMOB_SY_HARM_1KW_1W);
	export_constant(UMOB_SY_HARM_1E_10W);
	export_constant(UMOB_SY_HARM_10E_100W);
	export_constant(UMOB_SY_HARM_100E_1KW);
	export_constant(UMOB_SY_HARM_1KE_1E);
	export_constant(UMOB_SY_HARM_1WE_10E);
//-------------------------------------------------
