...
/**
 * Server cache to be flushed to inter the Guild EXP 要刷新的服务器缓存在公会经验中
 * @see DBApply
 */
...
/*====================================================
 * Return taxed experience from player sd to guild 将玩家sd的纳税经验退还给公会
 *---------------------------------------------------*/
 ...
 * Add this experience to guild exp 将此经验添加到公会经验
 * [Celest]
 *---------------------------------------------------*/
