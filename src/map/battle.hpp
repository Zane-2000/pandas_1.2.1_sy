...
enum e_battle_flag : uint16 {
	BF_NONE		= 0x0000, /// None					无伤害
	BF_WEAPON	= 0x0001, /// Weapon attack			物理攻击
	BF_MAGIC	= 0x0002, /// Magic attack			魔法攻击
	BF_MISC		= 0x0004, /// Misc attack			其他攻击
...
// eAthena additions
	...
	int rare_drop_announce; // chance <= to show rare drops global announces  机会<=显示罕见的下降全球宣布
